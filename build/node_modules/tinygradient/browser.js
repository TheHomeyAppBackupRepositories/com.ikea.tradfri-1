...
(function(global, factory) {
  ...
  const tinycolor2__default = /* #__PURE__ */_interopDefaultLegacy(tinycolor2);
  ...
  function interpolateHsv(stop1, stop2, steps, mode) {
    ...
    const end = stop2.color.toHsv(); // rgb interpolation if one of the steps in grayscale
    ...
    const step = stepize(start, end, steps);
    const gradient = [stop1.color]; // recompute hue
  ...
  function computeSubsteps(stops, steps) {
    const l = stops.length; // validation
  ...
  const TinyGradient = /* #__PURE__ */(function() {
    /**
    ...
    function TinyGradient(stops) {
      ...
      let l = stops.length;
      let p = -1;
      let lastColorLess = false; // create tinycolor objects and clean positions
    ...
    const _proto = TinyGradient.prototype;
  ...
  const tinygradient = function tinygradient(stops) {
    // varargs
