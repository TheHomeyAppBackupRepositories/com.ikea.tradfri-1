    ...
    3: [function(require, module, exports) {
      ...
      function setup(env) {
        ...
        */
        ...
        function disable() {
          const namespaces = [].concat(_toConsumableArray(createDebug.names.map(toNamespace)), _toConsumableArray(createDebug.skips.map(toNamespace).map(namespace => {
            return `-${namespace}`;
          }))).join(',');
          createDebug.enable('');
          return namespaces;
