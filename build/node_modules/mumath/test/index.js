...
assert.equal(m.round(0.3, 0.5), 0.5);

// multiple
assert.equal(m.isMultiple(100, 10), true);
assert.equal(m.isMultiple(100.1, 10, 0.1), true);
...
assert.equal(m.lerp(1, 0, 0.5), 0.5);


// step
assert.equal(m.scale(0.1, [1, 2, 5]), 0.1);
assert.equal(m.scale(0.1, [1, 2, 5]), 0.1);
